...
public class EventTime {
    ...
    public static void main(String[] args) {
        ...
        String dayLine1 = s.nextLine();
        String timeLine1 = s.nextLine();
        String dayLine2 = s.nextLine();
        String timeLine2 = s.nextLine();

        int day1 = Integer.parseInt(dayLine1.substring(4));
        int day2 = Integer.parseInt(dayLine2.substring(4));
        int hours1 = 0;
        int min1 = 0;
        int sec1 = 0;
        int hours2 = 0;
